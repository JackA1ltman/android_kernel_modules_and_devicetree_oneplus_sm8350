...
kernel_defconfig_update_flag := $(PRODUCT_OUT)/.kernel_defconfig.oplus_update_flag
...
ifeq ($(GKI_KERNEL),1)
  ...
  ifneq (,$(findstring -qgki,$(KERNEL_DEFCONFIG)))
    ...
    BOARD_KERNEL-GKI_BOOTIMAGE_PARTITION_SIZE := 0x0C000000

gki_kernel_defconfig_update_flag := $(PRODUCT_OUT)/.gki_kernel_defconfig.oplus_update_flag
ifeq ($(OPLUS_FORCE_UPDATE_MAKEFILE),true)
